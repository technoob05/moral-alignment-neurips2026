# ============================================================================
# EXP04: BAYESIAN BELIEF AGGREGATION (Training-Free)
# ============================================================================
# # IDEA: Each persona's output is a LIKELIHOOD. Sequential Bayesian update:
...
WORK_DIR = Path("/kaggle/working/EXP04_BAYESIAN")
...
METHODS_TO_EVAL = ["VANILLA", "BAYESIAN_BELIEF"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","BAYESIAN_BELIEF":"#2980B9"}
METHOD_LABELS={"VANILLA":"Vanilla","BAYESIAN_BELIEF":"Bayesian Belief (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP04: Bayesian Belief Aggregation",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp04.png",dpi=150,bbox_inches="tight"); plt.show()
