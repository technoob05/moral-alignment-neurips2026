# ============================================================================
# EXP10: CONSTITUTIONAL CULTURAL DECODING (Training-Free)
# ============================================================================
# # IDEA: Per-culture moral constitutions from human preference data.
...
WORK_DIR = Path("/kaggle/working/EXP10_CONSTITUTIONAL")
...
METHODS_TO_EVAL = ["VANILLA", "CONSTITUTIONAL"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","CONSTITUTIONAL":"#C0392B"}
METHOD_LABELS={"VANILLA":"Vanilla","CONSTITUTIONAL":"Constitutional Cultural (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP10: Constitutional Cultural",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp10.png",dpi=150,bbox_inches="tight"); plt.show()
