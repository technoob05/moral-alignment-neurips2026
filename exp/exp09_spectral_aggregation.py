# ============================================================================
# EXP09: SPECTRAL AGGREGATION (Training-Free)
# ============================================================================
# # IDEA: SVD-based denoising of cultural consensus. Stack persona logits into
...
WORK_DIR = Path("/kaggle/working/EXP09_SPECTRAL")
...
METHODS_TO_EVAL = ["VANILLA", "SPECTRAL_AGG"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","SPECTRAL_AGG":"#3498DB"}
METHOD_LABELS={"VANILLA":"Vanilla","SPECTRAL_AGG":"Spectral Aggregation (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP09: Spectral Aggregation",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp09.png",dpi=150,bbox_inches="tight"); plt.show()
