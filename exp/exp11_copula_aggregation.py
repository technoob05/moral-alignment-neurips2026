# ============================================================================
# EXP11: COPULA-BASED DEPENDENCE AGGREGATION (Training-Free)
# ============================================================================
# # IDEA: Agents may be correlated. Copula aggregation upweights UNIQUE
...
WORK_DIR = Path("/kaggle/working/EXP11_COPULA")
...
METHODS_TO_EVAL = ["VANILLA", "COPULA_AGG"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","COPULA_AGG":"#1ABC9C"}
METHOD_LABELS={"VANILLA":"Vanilla","COPULA_AGG":"Copula Aggregation (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP11: Copula Aggregation",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp11.png",dpi=150,bbox_inches="tight"); plt.show()
