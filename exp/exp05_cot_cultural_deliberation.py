# ============================================================================
# EXP05: CHAIN-OF-THOUGHT CULTURAL DELIBERATION (Training-Free)
# ============================================================================
# # IDEA: Two-stage approach: (1) Each persona generates reasoning chain,
...
WORK_DIR = Path("/kaggle/working/EXP05_COT")
...
METHODS_TO_EVAL = ["VANILLA", "COT_DELIBERATION"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","COT_DELIBERATION":"#8E44AD"}
METHOD_LABELS={"VANILLA":"Vanilla","COT_DELIBERATION":"CoT Deliberation (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP05: CoT Cultural Deliberation",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp05.png",dpi=150,bbox_inches="tight"); plt.show()
