# ============================================================================
# EXP14: RECURSIVE SELF-CONSISTENCY ALIGNMENT (Training-Free)
# ============================================================================
# # IDEA: Sample multiple outputs from each persona, aggregate by
...
WORK_DIR = Path("/kaggle/working/EXP14_SELFCONSIST")
...
METHODS_TO_EVAL = ["VANILLA", "SELF_CONSISTENCY"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","SELF_CONSISTENCY":"#27AE60"}
METHOD_LABELS={"VANILLA":"Vanilla","SELF_CONSISTENCY":"Self-Consistency (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP14: Self-Consistency",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp14.png",dpi=150,bbox_inches="tight"); plt.show()
