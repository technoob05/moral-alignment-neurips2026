# ============================================================================
# EXP12: ADAPTIVE MIXTURE-OF-CULTURAL-EXPERTS (Training-Free)
# ============================================================================
# # IDEA: Route to most relevant persona per scenario. Elder for age dilemmas,
...
WORK_DIR = Path("/kaggle/working/EXP12_MOE")
...
METHODS_TO_EVAL = ["VANILLA", "ADAPTIVE_MOE"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","ADAPTIVE_MOE":"#9B59B6"}
METHOD_LABELS={"VANILLA":"Vanilla","ADAPTIVE_MOE":"Adaptive MoE (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP12: Adaptive MoE",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp12.png",dpi=150,bbox_inches="tight"); plt.show()
