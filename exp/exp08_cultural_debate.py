# ============================================================================
# EXP08: MULTI-ROUND CULTURAL DEBATE (Training-Free)
# ============================================================================
# # IDEA: Token-level debate between personas. At each decoding step, personas
...
WORK_DIR = Path("/kaggle/working/EXP08_DEBATE")
...
METHODS_TO_EVAL = ["VANILLA", "CULTURAL_DEBATE"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","CULTURAL_DEBATE":"#2ECC71"}
METHOD_LABELS={"VANILLA":"Vanilla","CULTURAL_DEBATE":"Cultural Debate (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP08: Multi-Round Cultural Debate",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp08.png",dpi=150,bbox_inches="tight"); plt.show()
