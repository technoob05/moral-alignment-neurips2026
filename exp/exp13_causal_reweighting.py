# ============================================================================
# EXP13: CAUSAL FEATURE REWEIGHTING (Training-Free)
# ============================================================================
# # IDEA: Use known causal structure (ACME) from Moral Machine to correct
...
WORK_DIR = Path("/kaggle/working/EXP13_CAUSAL")
...
METHODS_TO_EVAL = ["VANILLA", "CAUSAL_REWEIGHT"]
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","CAUSAL_REWEIGHT":"#F39C12"}
METHOD_LABELS={"VANILLA":"Vanilla","CAUSAL_REWEIGHT":"Causal Reweighting (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP13: Causal Reweighting",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp13.png",dpi=150,bbox_inches="tight"); plt.show()
