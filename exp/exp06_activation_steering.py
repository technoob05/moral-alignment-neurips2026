# ============================================================================
# EXP06: ACTIVATION STEERING (Training-Free)
# ============================================================================
# # IDEA: Extract cultural steering vectors from activation differences.
...
WORK_DIR = Path("/kaggle/working/EXP06_STEERING")
...
METHODS_TO_EVAL = ["VANILLA", "ACTIVATION_STEERING"]
...
# ============================================================================
# CORE METHOD: ACTIVATION_STEERING
# ============================================================================
...
METHOD_COLORS={"Human":"#2C3E50","VANILLA":"#E74C3C","ACTIVATION_STEERING":"#16A085"}
METHOD_LABELS={"VANILLA":"Vanilla","ACTIVATION_STEERING":"Activation Steering (Ours)"}
def plot_radar(mp,hl):
    ...
    ax.legend(loc="upper right",bbox_to_anchor=(1.35,1.15)); ax.set_title("EXP06: Activation Steering",y=1.12,fontsize=13,fontweight="bold")
    plt.tight_layout(); plt.savefig(FIGS_DIR/"radar_exp06.png",dpi=150,bbox_inches="tight"); plt.show()
